...
export type NotificationType = 'achievement' | 'level_up' | 'challenge' | 'streak' | 'leaderboard' | 'sync_completed' | 'sync_started' | 'new_sync_request' | 'forum_rank_up' | 'forum_badge_earned' | 'forum_post_shared' | 'forum_post_imported' | 'forum_comment' | 'forum_vote' | 'gift' | 'pet_death' | 'pet_dying';
